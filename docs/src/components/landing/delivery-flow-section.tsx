...
const pipelineActions = ["chat.complete", "guard.check", "provider.route"];
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="flex flex-col items-start gap-2.5">
            ...
            <EventRow
              ...
              statusLabel={phase === 1 ? "✓ openai" : "⟳ Routing"}
...
// ─── Request Processing Pipeline Section ─────────────────────
      ...
      <div className="container max-w-(--fd-layout-width) mx-auto px-4 sm:px-6">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
          ...
          <div className="flex flex-col">
            <SectionHeader
              badge="Request Processing Pipeline"
              title="From request to response, fully orchestrated."
              description="Nexus orchestrates the entire request lifecycle — tenant isolation, guardrail enforcement, intelligent routing, response caching, and usage tracking."
              align="left"
            />

            <div className="mt-8 space-y-5">
              <FeatureBullet
                title="15 Plugin Lifecycle Hooks"
                description="RequestReceived, ProviderFailed, GuardrailBlocked, and 12 more. Wire metrics, audit trails, or custom processing logic without modifying engine code."
                delay={0.2}
              />
              <FeatureBullet
                title="Intelligent Routing"
                description="Priority, cost-optimized, and round-robin strategies with automatic fallback and circuit breaking across multiple providers."
                delay={0.3}
              />
              <FeatureBullet
                title="Response Caching"
                description="Deterministic cache keys with optional semantic matching. Memory, Redis, or custom cache backends. Cache hits skip provider calls entirely."
                delay={0.4}
              />
            </div>
