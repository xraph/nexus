...
const footerLinks = {
  ...
  Community: [
    ...
    {
      label: "Issues",
      href: "https://github.com/xraph/nexus/issues",
      external: true,
    },
    {
      label: "Discussions",
      href: "https://github.com/xraph/nexus/discussions",
      external: true,
    },
    {
      label: "Contributing",
      href: "https://github.com/xraph/nexus/blob/main/CONTRIBUTING.md",
      external: true,
    },
  ],
};
        ...
        <div className="grid grid-cols-2 gap-8 py-12 sm:py-16 md:grid-cols-5 lg:gap-12">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-fd-muted-foreground leading-relaxed max-w-xs">
              ...
              guardrails, cache responses, and manage multi-tenant access at
              scale.
            </p>
            <div className="flex items-center gap-3 mt-6">
              <a
                href="https://github.com/xraph/nexus"
                target="_blank"
                rel="noreferrer"
