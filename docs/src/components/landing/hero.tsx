...
// ─── Mini Gateway Pipeline Diagram ────────────────────────────
function MiniGatewayPipeline() {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      ...
      <div className="relative space-y-6 p-4">
        {/* Row 1: Request → Route → Guard → Complete */}
        <div className="flex items-center justify-center gap-0">
          ...
          <FlowNode label="Route" color="purple" size="sm" delay={0.55} />
          <FlowLine length={24} color="violet" delay={2} />
          <FlowNode label="Guard" color="violet" size="sm" delay={0.7} />
        ...
        <div className="flex items-start justify-center">
          <div className="space-y-2.5">
            ...
            >
              ...
              <StatusBadge status="delivered" label="cached" />
            </motion.div>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center justify-center gap-2 pt-2">
          <FloatingBadge label="Multi-Provider" delay={1.6} />
          <FloatingBadge label="Guardrails" delay={1.8} />
          <FloatingBadge label="Caching" delay={2.0} />
          <FloatingBadge label="Model Aliases" delay={2.2} />
        </div>
      </div>
    </motion.div>
  );
    ...
    <section className="relative w-full overflow-hidden">
      ...
      <div className="relative container max-w-(--fd-layout-width) mx-auto px-4 sm:px-6">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center py-20 sm:py-28 md:py-32">
          ...
          {/* Right: Mini gateway pipeline diagram */}
