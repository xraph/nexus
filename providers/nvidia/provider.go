// Package nvidia provides an NVIDIA NIM provider implementation for Nexus.
// NVIDIA NIM provides GPU-optimized inference with embedding support.
package nvidia
...
// Provider implements the Nexus provider interface for NVIDIA NIM.
...
// Option configures the NVIDIA NIM provider.
