// Package hyperbolic provides a Hyperbolic provider implementation for Nexus.
// Hyperbolic provides inference for open-source models.
package hyperbolic
...
const defaultBaseURL = "https://api.hyperbolic.xyz/v1"

// Provider implements the Nexus provider interface for Hyperbolic.
...
// Embed sends an embedding request — Hyperbolic does not support embeddings.
...
// Option configures the Hyperbolic provider.
