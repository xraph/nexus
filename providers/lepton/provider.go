// Package lepton provides a Lepton AI provider implementation for Nexus.
// Lepton AI provides serverless GPU inference.
package lepton
...
const defaultBaseURL = "https://api.lepton.ai/v1"

// Provider implements the Nexus provider interface for Lepton AI.
...
// New creates a new Lepton AI provider.
func New(apiKey string, opts ...Option) *Provider {
	...
	p.models = leptonModels()
	return p
}

// Name returns the provider identifier.
func (p *Provider) Name() string { return "lepton" }
...
// Embed sends an embedding request — Lepton AI does not support embeddings.
...
// Option configures the Lepton AI provider.
