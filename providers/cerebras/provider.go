// Package cerebras provides a Cerebras provider implementation for Nexus.
// Cerebras provides ultra-fast inference on Wafer Scale Engine hardware.
package cerebras
...
// Provider implements the Nexus provider interface for Cerebras.
...
// Embed sends an embedding request — Cerebras does not support embeddings.
