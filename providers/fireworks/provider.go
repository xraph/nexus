// Package fireworks provides a Fireworks AI provider implementation for Nexus.
...
// Provider implements the Nexus provider interface for Fireworks AI.
