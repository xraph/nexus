// Package xai provides an xAI (Grok) provider implementation for Nexus.
// xAI offers the Grok family of models with vision and tool-calling support.
package xai
...
// Provider implements the Nexus provider interface for xAI.
...
// Embed sends an embedding request — xAI does not support embeddings.
