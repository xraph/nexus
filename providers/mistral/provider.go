// Package mistral provides a Mistral AI provider implementation for Nexus.
// Mistral offers high-performance models with embeddings and vision support.
package mistral
...
// Provider implements the Nexus provider interface for Mistral.
